  ...
  <body id="page-top">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Pendaftaran Kursus Data Analyst</h1>
            </div>
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <form id="registrationForm" action="{{ route('create') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama"  placeholder="Masukan Nama Lngkap Anda" name="nama" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" name="no_hp" id="no_hp" placeholder="Masukkan nomor telepon" onkeypress="validateNumberInput(event)" required>
                                </div>
                                <div class="form-group">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <p>Kursus Data Analyst ini dirancang untuk pemula maupun yang sudah berpengalaman dalam Data Analyst. Anda akan belajarInstruktur yang berpengalaman.</p>
    ...
    <script>
      function validateNumberInput(event) {
          const key = event.key;
          // Memeriksa jika karakter yang dimasukkan bukan angka
          if (!/[0-9]/.test(key) && key !== "Backspace" && key !== "Tab") {
              event.preventDefault(); // Mencegah karakter yang tidak valid
      ...
      function showError(message) {
          // Tambahkan logika untuk menampilkan pesan kesalahan, misalnya di dalam elemen dengan ID tertentu
          const errorContainer = document.getElementById('errorContainer');
          errorContainer.textContent = message;
          errorContainer.style.color = 'red'; // Ganti warna teks menjadi merah
      }
